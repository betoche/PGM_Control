...
class SourceFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create source_file" do
    assert_difference('SourceFile.count') do
      post source_files_url, params: { source_file: { library_id: @source_file.library_id, name: @source_file.name } }
    end
  ...
  test "should update source_file" do
    patch source_file_url(@source_file), params: { source_file: { library_id: @source_file.library_id, name: @source_file.name } }
